...
function Contact() {
    ...
    return (
        <div id='contact'>
            <h1>Contact Me</h1>
            <div>
                <div id="contact-github" className='contactCard' onClick={() => { sendto("https://github.com/SurajYadav007") }}>
                    <img src={Github} alt="" />
                    <h5>Github</h5>
                    <p>SurajYadav007</p>
                </div>
                <div id="contact-linkedin" className='contactCard' onClick={() => { sendto("https://www.linkedin.com/in/suraj-yadav-dev007/") }}>
                    <img src={LinkedIn} alt="LinkedIn" />
                    <h5>Linkedin</h5>
                    <p>suraj-yadav-dev007</p>
                </div>
                <div id="contact-email" className='contactCard'>
                    <img src={Email} alt="" />
                    <h5>Email</h5>
                    <p>surajkyadav.9495@gmail.com</p>
                </div>
