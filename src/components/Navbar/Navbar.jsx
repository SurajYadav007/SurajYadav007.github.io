...
function Navbar() {
    ...
    const downloadHandle = () => {
        ...
        link.download = "Suraj Kumar Yadav Resume.pdf";
        link.href = resume;
        link.click();
        window.open(
            ...
            <div id='nav-menu'>
                ...
                <div id="largeScreenNavbar">
                    ...
                    <div>
                        ...
                        <a href="https://github.com/SurajYadav007" target="_blank" className="nav-link github">
                            GitHub
                        </a>
                    </div>
                </div>
            ...
            </div >
            {
                burger ? (<div id='smallScreenDropDown' >
                    <div>
                        ...
                        <a href="https://github.com/SurajYadav007" target="_blank" className="nav-link github" style={{ margin: "auto", width: "100px" }}
